  ...
  const testimonials = [
    {
      ...
      title: "07/12/2023",
      quote:
        "I appreciate the transparency and dedication of the Trumpcoin team. They seem genuinely committed to building a community around the coin, providing regular updates, and engaging with holders. It's refreshing to see developers who are so actively involved and responsive to their user base.",
    },
    {
      avatar:
    ...
    },
    {
      ...
      title: "03/13/2023",
      quote:
        "The creativity of the Trumpcoin developers is noteworthy. They've managed to create a memecoin that stands out in a crowded market, not just for its political association but also for its utility and potential for growth. They're proving that meme coins can be more than just a joke if backed by a strong vision and technical execution.",
    },
  ];
    ...
    <section className="py-14 bg-white-50/60">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl font-light">Meet Developers</h1>
        </div>
